...
import org.sunbird.kernel.extension.enums.AuditProperties;
import org.sunbird.kernel.extension.enums.GraphDACParams;
import org.sunbird.kernel.extension.enums.SystemProperties;
import org.neo4j.graphdb.GraphDatabaseService;
import org.neo4j.graphdb.Node;
import org.neo4j.graphdb.Relationship;
import org.neo4j.graphdb.event.LabelEntry;
import org.neo4j.graphdb.event.TransactionData;
import org.sunbird.kernel.extension.utils.LogAsyncGraphEvent;
...
public class ProcessTransactionData {
	...
	private Logger logger = LogManager.getLogger("org.sunbird.kernel.extension.ProcessTransactionData");
	...
	public void processTxnData(TransactionData data) {
		try {
			...
			logger.error("Exception while processing transaction data: " + e.getMessage(), e);
		}
	}
	...
	private List<Map<String, Object>> getUpdatedNodeMessages(TransactionData data, GraphDatabaseService graphDb,
		...
		try {
            ...
            logger.error("Error building updated nodes message: " + e.getMessage());
		}
		return lstMessageMap;
	}
		...
		try {
			...
			for (Long nodeId : deletedNodeIds) {
				...
				if (null != removedNodeProp && !removedNodeProp.isEmpty()) {
					...
					map.put(GraphDACParams.createdOn.name(), formatCurrentDate());
	...
	private List<Map<String, Object>> getRemovedTagsMessage(TransactionData data, GraphDatabaseService graphDb,
		...
		try {
			...
			logger.error("Error building removed tags message" + e.getMessage(), e);
		}
		return lstMessageMap;
	}
